  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between gap-x-6 p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="/" class="-m-1.5 p-1.5">
        ...
        <img class="h-16 rounded-md w-auto" src="https://res.cloudinary.com/shinkirin/image/upload/v1707878487/shinkirin/CCCD-Jamaica/cccdHeaderlogo.svg" alt="CCCD logo">
      </a>
    </div>
    <div class="hidden lg:flex lg:gap-x-12">
      <div>
        ...
        <!-- End of product menu dropdown button -->
          ...
          >
            <div class="mx-auto grid max-w-7xl grid-cols-4 gap-x-4 px-6 py-10 lg:px-8 xl:gap-x-8">
              <div class="group relative rounded-lg p-6 text-md leading-6 hover:bg-gray-50">
                ...
                <a href="/a" class="mt-6 block font-semibold text-blue-900 dark:text-blue-100">
                  Analytics
              ...
              <div class="group relative rounded-lg p-6 text-md leading-6 hover:bg-blue-50">
                ...
                <a href="/e" class="mt-6 block font-semibold text-blue-900 dark:text-blue-100">
                  Engagement
                  <span class="absolute inset-0"></span>
                </a>
              ...
              <div class="group relative rounded-lg p-6 text-md leading-6 hover:bg-blue-50">
                ...
                <a href="/s" class="mt-6 block font-semibold text-blue-900 dark:text-blue-100">
                  Security
                  <span class="absolute inset-0"></span>
                </a>
              ...
              <div class="group relative rounded-lg p-6 text-md leading-6 hover:bg-blue-50">
                ...
                <a href="/i" class="mt-6 block font-semibold text-blue-900 dark:text-blue-100">
                  Integrations
                  <span class="absolute inset-0"></span>
                </a>
                <p class="mt-1 text-blue-600">Your customers’ data will be safe and secure</p>
            ...
            <div class="bg-blue-50">
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid grid-cols-3 divide-x divide-blue-900/5 border-x border-blue-900/5">
                  <a href="w" class="flex items-center justify-center gap-x-2.5 p-3 text-md font-semibold leading-6 text-blue-900 dark:text-blue-100 hover:bg-blue-100">
                    <svg class="h-5 w-5 flex-none text-blue-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                      <path fill-rule="evenodd" d="M2 10a8 8 0 1116 0 8 8 0 01-16 0zm6.39-2.908a.75.75 0 01.766.027l3.5 2.25a.75.75 0 010 1.262l-3.5 2.25A.75.75 0 018 12.25v-4.5a.75.75 0 01.39-.658z" clip-rule="evenodd" />
                    </svg>
                    Watch demo
                  </a>
                  <a href="/contact" class="flex items-center justify-center gap-x-2.5 p-3 text-md font-semibold leading-6 text-blue-900 dark:text-blue-100 hover:bg-blue-100">
                    <svg class="h-5 w-5 flex-none text-blue-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                      <path fill-rule="evenodd" d="M2 3.5A1.5 1.5 0 013.5 2h1.148a1.5 1.5 0 011.465 1.175l.716 3.223a1.5 1.5 0 01-1.052 1.767l-.933.267c-.41.117-.643.555-.48.95a11.542 11.542 0 006.254 6.254c.395.163.833-.07.95-.48l.267-.933a1.5 1.5 0 011.767-1.052l3.223.716A1.5 1.5 0 0118 15.352V16.5a1.5 1.5 0 01-1.5 1.5H15c-1.149 0-2.263-.15-3.326-.43A13.022 13.022 0 012.43 8.326 13.019 13.019 0 012 5V3.5z" clip-rule="evenodd" />
                    </svg>
                    Contact sales
                  </a>
                  <a href="/v" class="flex items-center justify-center gap-x-2.5 p-3 text-md font-semibold leading-6 text-blue-900 dark:text-blue-100 hover:bg-blue-100">
                    <svg class="h-5 w-5 flex-none text-blue-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
