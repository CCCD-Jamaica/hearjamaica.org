  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between gap-x-6 p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="/" class="-m-1.5 p-1.5">
        ...
        <img class="h-16 dark:p-1 rounded-md w-auto" src="https://res.cloudinary.com/shinkirin/image/upload/v1707675785/shinkirin/CCCD-Jamaica/updated-logo.webp" alt="CCCD logo">
      </a>
    </div>
  ...
  >
    ...
    <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      <div class="flex items-center gap-x-6">
        <a href="/" class="-m-1.5 p-1.5">
          <span class="sr-only">Caribbean Christian Centre for the Deaf</span>
          <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="CCCD logo">
        </a>
